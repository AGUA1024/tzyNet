...
func dbCfgIni() {
	dbCfg.User = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "user").(string)
	dbCfg.Pass = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "pass").(string)
	dbCfg.AllHostCfg = common.GetYamlMapCfg("mysqlCfg", "mysql", "game").(map[string]any)
	dbCfg.MaxOpenCon = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "maxOpenCon").(int)
	dbCfg.MaxIdleConns = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "maxIdleConns").(int)
	dbCfg.ConLiveTime = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "conLiveTime").(int)
	dbCfg.PieceNum = common.GetYamlMapCfg("mysqlCfg", "mysql", "common", "pieceNum").(int)
}
