...
func redisCfgIni() {
	RedisCfg.User = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "user").(string)
	RedisCfg.Pass = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "pass").(string)
	RedisCfg.MaxOpenCon = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "maxOpenCon").(int)
	RedisCfg.MaxIdleConns = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "maxIdleConns").(int)
	RedisCfg.ConLiveTime = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "conLiveTime").(int)
	RedisCfg.PieceNum = tCommon.GetYamlMapCfg("redisCfg", "redis", "common", "pieceNum").(int)
	RedisCfg.AllHostCfg = tCommon.GetYamlMapCfg("redisCfg", "redis", "game").(map[string]any)
}
